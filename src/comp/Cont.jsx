    ...
    <>
      ...
      <div className="w-full flex    h-48 justify-center gap-1 bg-white">
        <div className="mt-5 w-[25%] h-[70%] md:w-[15%] shadow-md border-4">
          <center className="animate-bounce text-3xl md:text-2xl md:w-[20%] hover:bg-green-900 md:ml-20  mt-5 justify-center p-2  w-[40%] ml-6 rounded-[50%]  text-white bg-indigo-600 ">
        ...
        <div className="mt-5 w-[25%] h-[70%] md:w-[15%] shadow-md border-4">
          ...
          <center className="mt-5 mr-5 md:mr-2 hover:text-green-500 text-[19px] md:text-3xl  font-bold">
