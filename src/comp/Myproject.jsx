...
function Myproject() {
  return (
    ...
    <div className='md:flex md:flex-wrap justify-center md:justify-center w-100%  md:h-100% md:w-100% h-100%'>
        <div className=' w-[80%]  shadow-2xl   ml-12  items-center md:blur-[2px] hover:blur-none  h-[428px] md:w-[23%] rounded-xl  mb-5 md:h-[420px] border-2'>
        ...
        <div className='w-[80%] ml-12 shadow-lg  items-center md:blur-[2px] hover:blur-none mb-5    h-[428px] md:w-[23%] rounded-xl md:h-[450px] border-2 ' >
        ...
        <div className='w-[80%] ml-12 shadow-lg md:blur-[2px] hover:blur-none  items-center  h-[428px] md:w-[23%] rounded-xl md:h-[454px] border-2'>
        <img className=' rounded-lg  h-[200px] w-full' src="./e-com.png" alt="projectimg" />
            ...
            <a target='blank' href="https://github.com/shubashdutta"><button className=' md:text-2xl text-lg md:ml-22 mt-1  ml-20 hover:bg-green-800 rounded-lg bg-indigo-900 text-white  border-2'>socre code</button></a>
        </div>
    </div>
    </div>
    </>
