...
function Myproject() {
  return (
    ...
    <div className='md:flex md:flex-wrap justify-center md:justify-center w-100%  md:h-100% md:w-100% h-100%'>
        <div className=' w-[80%]  shadow-2xl   ml-11  items-center md:blur-[2px] hover:blur-none  h-[439px] md:w-[23%] rounded-xl  mb-5 md:h-[439px] border-2'>
        ...
        <div className='w-[80%] ml-11 shadow-lg  items-center md:blur-[2px] hover:blur-none mb-5    h-[425px] md:w-[23%] rounded-xl md:h-[429px] border-2 ' >
        ...
        <div className='w-[80%]  ml-11 shadow-lg md:blur-[2px] hover:blur-none  items-center  h-[435px] md:w-[23%] rounded-xl md:h-[448px] border-2'>
