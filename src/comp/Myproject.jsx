...
function Myproject() {
  return (
    ...
    <div className='md:flex md:flex-wrap justify-center md:justify-center w-100%  md:h-100% md:w-100% h-100%'>
        <div className=' w-[80%]  shadow-2xl   ml-12  items-center md:blur-[2px] hover:blur-none  h-[432px] md:w-[23%] rounded-xl  mb-5 md:h-[425px] border-2'>
        ...
        <div className='w-[80%] ml-12 shadow-lg  items-center md:blur-[2px] hover:blur-none mb-5    h-[425px] md:w-[23%] rounded-xl md:h-[430px] border-2 ' >
        ...
        <div className='w-[80%] ml-12 shadow-lg md:blur-[2px] hover:blur-none  items-center  h-[432px] md:w-[23%] rounded-xl md:h-[452px] border-2'>
