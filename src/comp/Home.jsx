    ...
    <>
      <div className='md:w-full md:flex  mt-10'>
        ...
        <div className='md:basis-[40%] md:px-20 md:mt-10 md:items-center'>
          ...
          <h6 className=' md:text-3xl text-white w-full ml-1  md:text-center md:mt-1  text-xl  '> I am <span className=' text-[#f8ae86] font-bold text-xl'>{displayedText}</span></h6>
          ...
          <hr className=' border-b-4  md:justify-center md: ml-28  mt-2 mx-4'></hr>
        </div>
      </div>
