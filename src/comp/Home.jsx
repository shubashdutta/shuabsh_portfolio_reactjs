    ...
    <>
      <div className='md:w-full md:flex md:h[70%]  mt-10'>
        <div className='md:basis-[60%]   '>
          <img className='md:w-full w-full  rounded-3xl md:h-[450px] md:backdrop-grayscale   md:px-5 md:overflow-hidden md:rounded-[15%]  ' src="./myimg2.png" alt="" />
        </div>
        <div className='md:basis-[40%] md:px-20 md:mt-10 md:items-center'>
          ...
          <h6 className=' md:text-3xl text-white w-full ml-2  md:text-center md:mt-1  text-xl  '> I am <span className=' text-[#f8ae86] font-bold text-xl'>{displayedText}</span></h6>
